...
export class MessageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.route.params
      ...
      .subscribe(id => {
        ...
        if (this.selectedConv.messages.length != 0)
  ...
  scrollToLastMessage(): void {
    setTimeout(() =>
      document.getElementById(this.selectedConv.messages[this.selectedConv.messages.length - 1].id.toString()).scrollIntoView(), 5);
  }
